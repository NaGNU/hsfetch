...
getDynLibDir  = catchIO (getEnv "rfetch_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "rfetch_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "rfetch_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "rfetch_sysconfdir") (\_ -> return sysconfdir)
